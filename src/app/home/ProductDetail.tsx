...
export default function ProductDetail({
  ...
  else if (product.category === 'calzado' || product.category === 'zapatillas')
    sizes = Array.from({ length: 9 }, (_, i) => 34 + i);
  else sizes = ['Única'];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {(() => {
          const supabaseUrl =
            'https://ktpajrnflcqwgaoaywuu.supabase.co/storage/v1/object/public/products/';
          const imageUrl =
            images[currentImg] && !images[currentImg].startsWith('http')
            ...
            {images.map((_, i) => (
              <span
                ...
                style={{
                  ...
                  height: 10,
                  borderRadius: '50%',
                  background: i === currentImg ? '#b5ff00' : '#ddd',
                  display: 'block',
      ...
      <div style={{ padding: '24px 24px 0 24px' }}>
        ...
        <div
          style={{ color: '#222', fontSize: 16, marginBottom: 18, lineHeight: 1.5 }}
      ...
      >
        ...
        >
          ...
          <span
            ...
            style={{ fontSize: 24, fontWeight: 700, minWidth: 28, textAlign: 'center' }}
          >
            {quantity}
          </span>
          <button

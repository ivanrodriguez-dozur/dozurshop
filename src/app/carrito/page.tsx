        ...
        <>
            ...
            {items.map((item) => (
              ...
              >
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    update(item.id, item.size, Math.max(1, item.qty - 1));
                  }}
                  style={{
                    border: 'none',
                    background: '#eee',
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    update(item.id, item.size, item.qty + 1);
                  }}
                  style={{
                    border: 'none',
                    background: '#181818',
          ...
          >
            ...
            >
              ...
              <span>
                {delivery === 0 ? (
                  <span style={{ color: '#00b300', fontWeight: 700 }}>Gratis*</span>
                ) : (
                  `$${delivery.toLocaleString('es-CO')}`
                )}
              </span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
